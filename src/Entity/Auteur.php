...
class Auteur
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Nationalite", inversedBy="auteursObj")
    ...
    public function getNationalites(): ?Nationalite
    {
        return $this->Nationalites;
    }

    public function setNationalites(?Nationalite $Nationalites): self
    {
